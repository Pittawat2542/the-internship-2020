...
var fetchData = function () { return __awaiter(void 0, void 0, void 0, function () {
    var response, $, listOfCompanies, parsedListOfCompanies;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, axios_1.default.get('https://theinternship.io')];
            case 1:
                response = _a.sent();
                $ = cheerio_1.default.load(response.data);
                listOfCompanies = $('#__layout>div>div>section:nth-child(5)>.container>div').toArray()[1];
